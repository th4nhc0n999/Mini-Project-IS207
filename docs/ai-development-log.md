# AI Development Log — MedSi

Nhật ký ghi lại các giai đoạn phát triển, quyết định kiến trúc và lưu ý kỹ thuật khi xây dựng hệ thống MedSi.
...
- **Giai đoạn 2 (Database & Models):**
  ...
  - Phạm vi role tài khoản hiện tại chỉ gồm `patient` và `admin`; `doctors` là hồ
